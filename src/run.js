...
import makeRoutesPosts from "./routes/makeRoutesPosts.js"
import makeRoutesCategories from "./routes/makeRoutesCategories.js"
...
const run = async (config) => {
  ...
  makeRoutesPosts({ app, db })
  makeRoutesCategories({ app, db })
